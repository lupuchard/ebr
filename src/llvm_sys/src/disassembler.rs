...
pub type LLVMOpInfoCallback =
    extern "C" fn(DisInfo: *mut ctypes::c_void,
                  PC: u64, Offset: u64,
                  Size: u64,
                  TagType: i32,
                  TagBuf: *mut ctypes::c_void)
        -> i32;
...
extern "C" {
    pub fn LLVMCreateDisasm(TripleName: *const i8,
                            DisInfo: *mut ctypes::c_void,
                            TagType: i32,
                            GetOpInfo: LLVMOpInfoCallback,
                            SymbolLookUp: LLVMSymbolLookupCallback)
     -> LLVMDisasmContextRef;
    pub fn LLVMCreateDisasmCPU(Triple: *const i8,
                               CPU: *const i8,
                               DisInfo: *mut ctypes::c_void,
                               TagType: i32,
                               GetOpInfo: LLVMOpInfoCallback,
                               SymbolLookUp: LLVMSymbolLookupCallback)
     -> LLVMDisasmContextRef;
    pub fn LLVMCreateDisasmCPUFeatures(Triple: *const i8,
                                       CPU: *const i8,
                                       Features: *const i8,
                                       DisInfo: *mut ctypes::c_void,
                                       TagType: i32,
    ...
    pub fn LLVMDisasmInstruction(DC: LLVMDisasmContextRef,
                                 ...
                                 PC: u64, OutString: *mut i8,
                                 OutStringSize: ctypes::size_t) -> ctypes::size_t;
}
